        ...
        <div className=' mx-5  mt-20'>
            <div className='md:grid md:grid-cols-3'>
                <div className='md:border md:border-[2px] ml-5 md:border-t-0 md:border-b-0   md:border-l-0 '>
                    <div className='mt-40'>
                        <img src={shiping} alt="" className='border ml-5 border-purple-800 p-[100px] hover:bg-purple-800 mt-[-150px]  w-[300px] border-[1px] rounded-full ' />
                ...
                <div className='md:border md:border-[2px]  md:border-t-0 md:border-b-0   md:border-s-black '>
                    <div className='mt-40 '>
                        <img src={service} alt="" className='border ml-10 border-purple-800 p-[100px] hover:bg-purple-800 mt-[-150px]  w-[300px] border-[1px] rounded-full ' />
                ...
                <div className=' ml-10    '>
                    <div className='mt-40'>
                        <img src={custom} alt="" className='border border-purple-800 p-[100px] hover:bg-purple-800 mt-[-150px]  w-[300px] border-[1px] rounded-full ' />
